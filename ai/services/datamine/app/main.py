"""FastAPI application for the Datamine service (Service 16)."""
...
async def lifespan(_app: FastAPI) -> AsyncIterator[None]:
    ...
    log.info("starting datamine service")

    await connect_all()

    log.info("datamine service ready")
    yield

    log.info("shutting down datamine service")
...
def create_app() -> FastAPI:
    cfg = get_config()
    app = FastAPI(
        title="Civitro Datamine Service",
