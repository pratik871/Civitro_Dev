"""FastAPI application for the Promises service (Service 10)."""
...
async def lifespan(_app: FastAPI) -> AsyncIterator[None]:
    ...
    log.info("starting promises service")

    await connect_all()

    log.info("promises service ready")
    yield

    log.info("shutting down promises service")
...
def create_app() -> FastAPI:
    cfg = get_config()
    app = FastAPI(
        title="Civitro Promise Tracker Service",
