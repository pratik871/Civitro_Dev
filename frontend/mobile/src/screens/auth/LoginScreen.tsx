      ...
      >
        <View style={styles.header}>
          ...
          <View style={styles.logoWrap}>
            <Svg width={Math.min(180, Dimensions.get('window').width * 0.45)} height={Math.min(103, Dimensions.get('window').width * 0.26)} viewBox="0 0 641 366">
          ...
          <View style={styles.taglineRow}>
            <Text style={styles.taglineText} numberOfLines={1} adjustsFontSizeToFit minimumFontScale={0.6}>{'DEMOCRACY'}</Text>
            <Text style={styles.taglineDot}>{'\u2022'}</Text>
            <Text style={styles.taglineText} numberOfLines={1} adjustsFontSizeToFit minimumFontScale={0.6}>{'YOU SHAPE'}</Text>
