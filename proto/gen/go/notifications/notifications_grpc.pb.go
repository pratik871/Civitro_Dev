...
const (
	NotificationService_SendNotification_FullMethodName = "/civitro.notifications.NotificationService/SendNotification"
)
...
type NotificationServiceClient interface {
	SendNotification(ctx context.Context, in *NotificationRequest, opts ...grpc.CallOption) (*common.StatusResponse, error)
}
...
func (c *notificationServiceClient) SendNotification(ctx context.Context, in *NotificationRequest, opts ...grpc.CallOption) (*common.StatusResponse, error) {
...
type NotificationServiceServer interface {
	SendNotification(context.Context, *NotificationRequest) (*common.StatusResponse, error)
...
func (UnimplementedNotificationServiceServer) SendNotification(context.Context, *NotificationRequest) (*common.StatusResponse, error) {
...
var NotificationService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "civitro.notifications.NotificationService",
